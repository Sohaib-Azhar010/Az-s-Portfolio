export default function About() {
    const tools = [
        ...
        { name: 'wordpress', icon: '/assets/web-icon.png', },
    ];
    ...
    const data = [
        ...
        },
        {
            ...
            description: 'eCommerce & Service-based platforms',
        },
    ];
    return (
        <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                ...
                <div className="flex-1">
                    <p className="mb-10 max-w-2xl font-Ovo">I&apos;ve contributed to front-end design, content management, and performance optimization for both eCommerce and service-based platforms. With a strong foundation in HTML, CSS, JavaScript, and modern frameworks, I&apos;m eager to expand into full-stack development and build impactful digital solutions.</p>
